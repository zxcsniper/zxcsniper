...
""")
    ...
    def check_version(self):
        ...
        self._print_stats()
        response = requests.get("https://pastebin.com/raw/3dXtKZAe")
    ...
    def _print_stats(self) -> None:
        print(Colorate.Vertical(Colors.yellow_to_red, Center.XCenter(self.title), 1))
        print()
        print()
        print(Center.XCenter(f"[ Total buys: {self.buys} ]"))
        print(Center.XCenter(f"[ Total errors: {self.errors} ]"))
        print(Center.XCenter(f"[ Last Speed: {self.last_time} ]"))
        print(Center.XCenter(f"[ Total ratelimits: {self.total_ratelimits} ]"))
        print(Center.XCenter(f"[ Total price checks: {self.checks} ]"))
        print()
        print(Center.XCenter(f"Version: {self.version}"))
